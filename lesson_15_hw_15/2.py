...
bonus to buy, and build, the largest three-dimensional beer can pyramid you can. And then probably drink those beers,
...
def beeramid(bonus, price):
    result = []
    number = 0
    while (sum(result) + (number + 1) ** 2) <= bonus // price:
        number += 1
